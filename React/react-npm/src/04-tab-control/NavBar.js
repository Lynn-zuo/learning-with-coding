    ...
    render() {
        ...
        return (
            <div className="nav-bar">
                {children && children[0] && <div className="nav-item nav-left">{children[0]}</div>}
                {children && children[1] && <div className="nav-item nav-center">{children[1]}</div>}
                {children && children[2] && <div className="nav-item nav-right">{children[2]}</div>}
